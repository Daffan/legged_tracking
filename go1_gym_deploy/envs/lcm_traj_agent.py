...
class LCMAgent():
    def __init__(self, cfg, se, command_profile):
        ...
        self.is_currently_probing = False  # TODO: not sure what this probe do, keep it here for now
    ...
    def get_obs(self):
        ...
        if self.cfg["env"]["observe_heights"]:
            ...
            ob = np.concatenate((ob, 
                            self.measured_heights.reshape(1, -1)), axis=-1) * self.obs_scales["height_measurements"]
