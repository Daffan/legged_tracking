def train_go1(headless=True):
    ...
    Cfg.commands.traj_length = 1
    Cfg.commands.num_interpolation = 1
    Cfg.commands.x_mean = 3.2
    Cfg.commands.base_x = 3.2
    ...
    runner.learn(num_learning_iterations=42, init_at_random_ep_len=False, eval_freq=100, update_model=not args.freeze_model)
